...
<style>
/* ── Header ── */
.dash-header { padding: 6px 0 4px 0; margin-bottom: 0; }
.dash-title { font-size: 1.8rem; font-weight: 800; color: #F8FAFC; line-height: 1.2; margin: 0; }
.dash-subtitle { font-size: 0.82rem; color: #64748B; margin-top: 3px; }
    ...
    with status_col:
        if st.session_state.get("connected"):
            ...
            <div style='padding-top:10px; text-align:right;'>
                <span class='db-status-pill'>🟢 Connected · {db_type}</span>
            </div>
            """, unsafe_allow_html=True)
