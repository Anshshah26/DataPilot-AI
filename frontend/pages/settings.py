...
def show_settings():
    ...
    if st.session_state.get("connected"):
        ...
        st.markdown(f"""
        <div style="background: rgba(30,41,59,0.4); border: 1px solid #1E293B; border-radius: 8px; padding: 14px 20px; display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 16px;">
            <div style="display: flex; flex-direction: column;">
                <span style="font-size: 0.65rem; color: #475569; text-transform: uppercase; letter-spacing: 0.8px; font-weight: 600; margin-bottom: 4px;">Status</span>
                <span style="font-size: 0.85rem; color: #10B981; font-weight: 600;">● Connected</span>
            </div>
            <div style="display: flex; flex-direction: column;">
                <span style="font-size: 0.65rem; color: #475569; text-transform: uppercase; letter-spacing: 0.8px; font-weight: 600; margin-bottom: 4px;">Type</span>
                <span style="font-size: 0.85rem; color: #CBD5E1; font-weight: 500;">{db_icon_svg}&nbsp;{db_type}</span>
            </div>
            <div style="display: flex; flex-direction: column;">
                <span style="font-size: 0.65rem; color: #475569; text-transform: uppercase; letter-spacing: 0.8px; font-weight: 600; margin-bottom: 4px;">Database</span>
                <span style="font-size: 0.85rem; color: #CBD5E1; font-weight: 500;">{db_info.get('database', 'N/A')}</span>
            </div>
            <div style="display: flex; flex-direction: column;">
                <span style="font-size: 0.65rem; color: #475569; text-transform: uppercase; letter-spacing: 0.8px; font-weight: 600; margin-bottom: 4px;">Host</span>
                <span style="font-size: 0.85rem; color: #CBD5E1; font-weight: 500;">{db_info.get('host', 'N/A')}:{db_info.get('port', 'N/A')}</span>
            </div>
            <div style="display: flex; flex-direction: column;">
                <span style="font-size: 0.65rem; color: #475569; text-transform: uppercase; letter-spacing: 0.8px; font-weight: 600; margin-bottom: 4px;">User</span>
                <span style="font-size: 0.85rem; color: #CBD5E1; font-weight: 500;">{db_info.get('username', 'N/A')}</span>
            </div>
        </div>
        """, unsafe_allow_html=True)
    else:
